...
- `tests/test_mod003.py` — 272 added lines — greedy-balance
- `tests/test_mod060.py` — 265 added lines — greedy-balance
- `tests/test_mod097.py` — 235 added lines — greedy-balance
- `tests/test_mod045.py` — 209 added lines — greedy-balance
- `tests/test_mod002.py` — 193 added lines — greedy-balance
- `tests/test_mod059.py` — 186 added lines — greedy-balance
- `tests/test_mod018.py` — 159 added lines — greedy-balance
- `tests/test_mod103.py` — 151 added lines — greedy-balance
- `src/mod100/service100.py` — 140 added lines — greedy-balance
- `tests/test_mod070.py` — 139 added lines — greedy-balance
- `src/mod087/service087.py` — 122 added lines — greedy-balance
- `tests/test_mod067.py` — 121 added lines — greedy-balance
- `src/mod005/service005.py` — 114 added lines — greedy-balance
- `src/mod092/service092.py` — 110 added lines — greedy-balance
- `tests/test_mod026.py` — 98 added lines — greedy-balance
- `tests/test_mod048.py` — 94 added lines — greedy-balance
- `tests/test_mod014.py` — 85 added lines — greedy-balance
- `tests/test_mod035.py` — 77 added lines — greedy-balance
- `src/mod084/service084.py` — 73 added lines — greedy-balance
- `src/mod050/service050.py` — 70 added lines — greedy-balance
- `tests/test_mod078.py` — 70 added lines — greedy-balance
- `tests/test_mod010.py` — 66 added lines — greedy-balance
- `src/mod069/service069.py` — 64 added lines — greedy-balance
- `src/mod073/service073.py` — 60 added lines — greedy-balance
- `tests/test_mod007.py` — 56 added lines — greedy-balance
- `src/mod085/service085.py` — 53 added lines — greedy-balance
- `tests/test_mod047.py` — 53 added lines — greedy-balance
- `src/mod017/service017.py` — 52 added lines — greedy-balance
- `tests/test_mod093.py` — 52 added lines — greedy-balance
- `src/mod090/service090.py` — 50 added lines — greedy-balance
- `tests/test_mod021.py` — 44 added lines — greedy-balance
- `src/mod083/service083.py` — 39 added lines — greedy-balance
- `tests/test_mod068.py` — 37 added lines — greedy-balance
- `src/mod028/service028.py` — 36 added lines — greedy-balance
- `src/auth/handler00.py` — 34 added lines — security-affinity
- `tests/test_mod011.py` — 34 added lines — greedy-balance
- `src/auth/handler03.py` — 32 added lines — security-affinity
- `src/mod048/service048.py` — 31 added lines — greedy-balance
- `tests/test_mod064.py` — 30 added lines — greedy-balance
- `tests/test_mod019.py` — 27 added lines — greedy-balance
- `tests/test_mod104.py` — 27 added lines — greedy-balance
- `tests/test_mod013.py` — 26 added lines — greedy-balance
- `src/auth/handler07.py` — 24 added lines — security-affinity
- `src/mod054/service054.py` — 24 added lines — greedy-balance
- `tests/test_mod054.py` — 24 added lines — greedy-balance
- `src/mod015/service015.py` — 23 added lines — greedy-balance
- `src/auth/handler01.py` — 22 added lines — security-affinity
- `src/mod033/service033.py` — 22 added lines — greedy-balance
- `tests/test_mod051.py` — 21 added lines — greedy-balance
- `src/mod026/service026.py` — 20 added lines — greedy-balance
- `src/mod036/service036.py` — 20 added lines — greedy-balance
- `tests/test_mod080.py` — 19 added lines — greedy-balance
- `src/mod096/service096.py` — 18 added lines — greedy-balance
- `tests/test_mod063.py` — 18 added lines — greedy-balance
- `src/mod079/service079.py` — 17 added lines — greedy-balance
- `src/mod080/service080.py` — 16 added lines — greedy-balance
- `src/mod101/service101.py` — 16 added lines — greedy-balance
- `tests/test_mod020.py` — 15 added lines — greedy-balance
- `tests/test_mod016.py` — 13 added lines — greedy-balance
- `tests/test_mod072.py` — 12 added lines — greedy-balance
- `tests/test_mod084.py` — 11 added lines — greedy-balance
- `src/mod020/service020.py` — 10 added lines — greedy-balance
- `src/mod011/service011.py` — 9 added lines — greedy-balance
- `src/mod032/service032.py` — 9 added lines — greedy-balance
- `src/auth/handler02.py` — 8 added lines — security-affinity
- `src/mod102/service102.py` — 8 added lines — greedy-balance
- `tests/test_mod030.py` — 8 added lines — greedy-balance
- `src/auth/handler06.py` — 7 added lines — security-affinity
- `src/mod031/service031.py` — 7 added lines — greedy-balance
- `src/mod066/service066.py` — 7 added lines — greedy-balance
- `src/mod108/service108.py` — 7 added lines — greedy-balance
- `src/mod029/service029.py` — 6 added lines — greedy-balance
- `src/mod025/service025.py` — 5 added lines — greedy-balance
- `src/mod043/service043.py` — 5 added lines — greedy-balance
- `src/auth/handler05.py` — 3 added lines — security-affinity
- `src/auth/handler04.py` — 1 added lines — security-affinity
- `src/auth/handler08.py` — 1 added lines — security-affinity
...
- Owned: 77 files / 4342 added lines
